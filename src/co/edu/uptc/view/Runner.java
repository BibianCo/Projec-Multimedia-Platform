                                    ...
                                    do{
                                        ...
                                        switch (opc3) {
                                            case 1:
                                                ...
                                                if (administratorController.addMovie(title, description, category, LocalDate.parse(publicationDateStr), duration)) {
                                                ...
                                                if (moviesToDelete.isEmpty()) {
                                                    ...
                                                    if (selectedMovieIndex > 0 && selectedMovieIndex <= moviesToDelete.size()) {
                                                        ...
                                                        if (administratorController.deleteMovie(selectedMovie.getTitle())) {
                                                            System.out.println("Película eliminada exitosamente: " + selectedMovie.getTitle());
                                                        } else {
                                                            System.out.println("Error al eliminar la película. Película no encontrada.");
                                                        }
                                                    } else {
