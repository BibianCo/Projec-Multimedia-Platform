...
public class InterfazUser {
    ...
    public static void interfaz(User user) {
        ...
        if (!carga) {
            administratorController.cargaMultimedia();
            carga = true;
        }
    ...
    private static void userData(User user) {
        ...
        System.out.println(" Name:     " + user.getFirstName()
                ...
                + "\n Plan: \n" + "Description :" + user.getPlan().getDescription() + "  Value :"
        ...
        do {
            ...
            if (op.equals("yes")) {
                ...
                System.out.println(messErrorInt[1]);
                // userController.findUser(user.getEmail());
                userData(user);
            }
        } while (!flag);
    }
            ...
            try {
                ...
                switch (option) {
                    case 1:
                        ...
                        mediaType = Integer.parseInt(sc.nextLine());

                        System.out.println("Add the title");
                        title = sc.nextLine();

                        if (userController.addWishList(title, mediaType)) {
                    ...
                    case 2:
                        String wishList = userController.showWishList();
                ...
                do {
                    System.out.println("Do you want to continue in favorites? (yes/no)");
    ...
    private static void searchCategory(User user) {
        ...
        // series
        mediaPlayerApp.showTableSeriesByCategory(categoryNum);
        // movies
        mediaPlayerApp.showTableMoviesByCategory(categoryNum);
    ...
    private static void playEpisodes(User user, Season season, Serie serie) {
        ...
        do {
            ...
            if (selectedEpisode == 0) {
                playSeries(user, serie);
                return; // Salir del bucle principal si el usuario selecciona 0
            }

            if (selectedEpisode < 1 || selectedEpisode > season.getNumberOfChapters().size()) {
                System.out.println(
                ...
                do {
                    ...
                    if (flag) {
                        ...
                        System.out.println("1. Next chapter");
                        System.out.println("2. Previous chapter");
                    ...
                    switch (option) {
                        case 1:
                            ...
                            if (mpc.nextChapter(serie)) {
                                ...
                                System.out.println(" 3. exit");
                                flag = true;
                                return; // Salir del bucle interno si no hay un próximo capítulo
                        ...
                        case 2:
                            ...
                            if (!previousChapter) {
                                ...
                                return; // Salir del bucle interno si no hay un capítulo anterior
                            } else {
                                flag = true;
                        ...
                        case 3:
                            interfaz(user);
                            return; // Salir del bucle interno y continuar con el externo
                        default:
                            System.out.println("Invalid option. Please select a valid option.");
                    }
                } while (option != 3); // Bucle interno
            }
