...
public class ListReproduceTest {
    ...
    public void setUp() {
        ...
        m1 = new Movie(111, "blanca nieves", "una pelicula animada de Disney", LocalDate.of(2012, 12, 25), 10, cat1);
        m2 = new Movie(222, "Cenicienta", "una pelicula animada de Disney", LocalDate.of(2010, 05, 07), 10, cat1);
